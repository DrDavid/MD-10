...
var MfDPanel = {
	...
	new : func(name,canvas_group,svgFile,updateFunc) {
		...
		## Fontname helper --> the reason for the font errors? ####
		var font_mapper = func(family, weight) {
			var fontname="LiberationFonts/LiberationSans-Regular.ttd";
			if (family == "Liberation Sans" and weight == "normal") {
				fontname="flightgear/Fonts/LiberationFonts/LiberationSans-Regular.ttf";
			}
			return(fontname);
		};
