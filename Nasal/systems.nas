...
var systems =
{
	...
	init: func
	{
		print("MD-11 aircraft systems ... initialized");
		systems.loopid += 1;
	...
	reinit: func
	{
		print("MD-11 aircraft systems ... reinitialized");
...
var dialogs =
{
	autopilot: gui.Dialog.new("sim/gui/dialogs/autopilot/dialog", "Aircraft/MD-11/Systems/autopilot-dlg.xml"),
	radio: gui.Dialog.new("sim/gui/dialogs/radio-stack/dialog", "Aircraft/MD-11/Systems/radio-stack-dlg.xml"),
	lights: gui.Dialog.new("sim/gui/dialogs/lights/dialog", "Aircraft/MD-11/Systems/lights-dlg.xml"),
	doors: gui.Dialog.new("sim/gui/dialogs/doors/dialog", "Aircraft/MD-11/Systems/doors-dlg.xml"),
	failures: gui.Dialog.new("sim/gui/dialogs/failures/dialog", "Aircraft/MD-11/Systems/failures-dlg.xml"),
	tiller: gui.Dialog.new("sim/gui/dialogs/tiller/dialog", "Aircraft/MD-11/Systems/tiller-dlg.xml")
};
gui.menuBind("autopilot", "MD11.dialogs.autopilot.open();");
gui.menuBind("radio", "MD11.dialogs.radio.open();");
