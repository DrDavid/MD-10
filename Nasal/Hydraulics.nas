...
var HYDR = {
	new : func(prop1){
		...
		m.reng_primary_switch = props.globals.initNode("controls/hydraulics/system[2]/CENG_switch", 1, "BOOL");
		m.reng_running = props.globals.getNode("engines/engine[2]/run", 1);
		m.reng_primary_switch = props.globals.initNode("controls/hydraulics/system[3]/RENG_switch", 1, "BOOL");
